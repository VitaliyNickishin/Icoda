...
add_action('acf/init', function () {
    ...
    acf_register_block(array(
        'name'              => 'icoda-video-content',
        'title'             => __('Video with Content'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('video', 'content', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        'name'              => 'icoda-content-two-columns',
        'title'             => __('Content Two Columns'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('columns', 'content', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        ...
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('slider', 'content', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        'name'              => 'icoda-banner-price',
        'title'             => __('Banner with price'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('price', 'banner', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        'name'              => 'icoda-banner-email',
        'title'             => __('Banner with email'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('email', 'banner', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        'name'              => 'post-blog-hero',
        'title'             => __('Post Blog Hero'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('header','hero', 'icoda', 'blog'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
     ...
     acf_register_block(array(
        'name'              => 'post-authors',
        'title'             => __('Post Authors'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('authors', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        'name'              => 'post-heading-link',
        'title'             => __('Post Heading Link'),
        'description'       => __(''),
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('heading', 'link', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
    ...
    acf_register_block(array(
        ...
        'render_callback' => 'icoda_acf_block_render_callback',
        'category'            => 'icoda-posts',
        'keywords'            => array('block', 'slider', 'four', 'box', 'icoda'),
        'align'             => 'full',
        'supports'          => array(
            'align' => array('full', 'wide', 'center')
        ),
