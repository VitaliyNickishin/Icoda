...
<div class="report-box-wrapper">
    <div class="report-box key-insights">
        <div class="row mx-lg-n2">
            ...
            <div class="col-12 col-lg-4 px-lg-2" data-map="insights-ai-access">
                <div class="insights-box surface p-3">
                    ...
                    <div class="content">
                        <h3 class="title h3 mb-1"><?php _e('AI Access', 'icoda'); ?></h3>
                        <p class="text-muted mb-0"><?php _e('Well configured for AI bot access', 'icoda'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-4 px-lg-2 mt-1 mt-lg-0" data-map="insights-structured-data">
                <div class="insights-box surface p-3">
                    ...
                    <div class="content">
                        <h3 class="title h3 mb-1"><?php _e('Structured Data', 'icoda'); ?></h3>
                        <p class="text-muted mb-0"><?php _e('Basic structured data present', 'icoda'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-4 px-lg-2 mt-1 mt-lg-0" data-map="insights-technic">
                <div class="insights-box surface p-3">
                    ...
                    <div class="content">
                        <h3 class="title h3 mb-1"><?php _e('Technical Infrastructure', 'icoda'); ?></h3>
                        <p class="text-muted mb-0"><?php _e('Technical issues detecteds', 'icoda'); ?></p>
                    </div>
                </div>
            </div>
        </div>
