<div data-sticky-single="social-box" class="social-box align-items-center align-items-lg-start d-flex flex-column">
    ...
    <ul class="list-social  d-flex flex-lg-column">
        ...
        <?php /* ?>
        <li>
            <a class="link-instagram article-share-item" href="#" data-socialname="instagram">
                <img src="/wp-content/uploads/2023/02/instagram-icon.svg" alt="instagram">
            </a>
        </li>

        <li>
            <a class="link-discord article-share-item" href="#" data-socialname="discord">
                <img src="/wp-content/uploads/2023/02/discord-icon.svg" alt="discord">
            </a>
        </li>
        <?php */ ?>
        <li>
