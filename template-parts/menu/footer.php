...
if ($args['location'] == 'footer-center-down' || $args['location'] == 'footer-right-down-2') {
    $show_only_first_item = true;
}

if ($args['location'] == 'footer-left' || $args['location'] == 'footer-center' || $args['location'] == 'footer-right-up' || $args['location'] == 'footer-right-down' ) {
