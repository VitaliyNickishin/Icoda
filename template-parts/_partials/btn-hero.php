<?php if ( !empty($_GET['section_hero_new'])) : ?>
    <div class="section-hero-new__btn d-flex flex-column flex-sm-row">
        ...
        <a class="btn d-flex align-items-center justify-content-center btn-outline-blue" href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/victorsmith04/intro-call'});return false;"><?php echo __('Book Intro Call', 'icoda'); ?></a>
    </div>
...
<?php else : ?>
    <div class="btn-wrap has-highlight">
        ...
        <a class="link-hover-underline mt-2 mt-md-4 text-center" href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/victorsmith04/intro-call'});return false;"><?php echo __('Book Intro Call', 'icoda'); ?></a>

        <?php /* ?><div class="calendly-inline-widget" data-url="https://calendly.com/victorsmith04/intro-call" style="min-width:320px;height:700px;"></div><?php */ ?>
    </div>
<?php endif; ?>
