<?php
    $authors = get_field('our_authors');
?>
<section class="section section-authors py-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between">
                    ...
                    <?php if (!empty($authors['link_to_authors'])): ?>
                        <a class="link-arrow d-flex align-items-center" href="<?php echo esc_url($authors['link_to_authors']); ?>">
                            <span class="d-none d-lg-block">
                                <?php echo esc_html($authors['link_text_desktop']); ?>
                            </span>
                            <span class="d-lg-none">
                                <?php echo esc_html($authors['link_text_mobile']); ?>
                            </span>
                        </a>
                    <?php endif; ?>
                </div>
                <div class="descriptions mt-3 mb-lg-4">
                    <?php echo $authors['descriptions']; ?>
                    ...
                    <?php foreach ($authors['list_authors'] as $item) : ?>
                        <div class="col col-lg-3 px-2">
                            <div class="list-leadership-item">
                                ...
                                <div class="leadership-item-avatar" data-bg="<?php echo $item['image']['url']; ?>" style="background-image:url(<?php echo $item['image']['url']; ?>);"></div>
                                <div class="leadership-item-des">
                                    ...
                                    <span class="leadership-des-text"><?= $item['about_author']; ?></span>
                                    ...
                                    <div class="leadership-social">
                                        ...
                                        <?php endif; ?>
                                        <?php if (!empty($item['linkendin'])) : ?>
                                            <div class="btn-linkedin">
                                                <a class="btn" href="<?php echo $item['linkendin']; ?>" target="_blank">
