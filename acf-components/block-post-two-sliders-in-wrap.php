        ...
        <div class="">
            <div class="container">
                <div class="row block-post-two-sliders-in-wrap-inner">
                    <?php if (!empty($block_title) || !empty($first_slider)): ?>
                    ...
                    <?php endif; ?>
                    <!-- second slider -->
                    <?php if (!empty($block_title_second) || !empty($second_slider)): ?>
                        <div class="col-12 pr-0 <?php if (!empty($first_slider)): ?>mt-5 pt-4 mt-lg-5<?php endif; ?>">
